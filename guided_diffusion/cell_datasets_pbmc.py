...
def load_data(
    *,
    ...
    celltype = pd.read_csv('/home/zqzhao/workplace/scDiffusion-main/dataset/pbmc68k/filtered_matrices_mex/68k_pbmc_barcodes_annotation.tsv', sep='\t')['celltype'].values
    print('#####################\n',np.unique(celltype).shape[0],'\n#####################')
